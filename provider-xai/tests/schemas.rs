//! Wire-schema snapshots for the `provider::xai::*` functions.
//!
//! `provider_xai::surface::catalog()` is the single source of truth for each
...
use provider_xai::surface::{catalog, FunctionSpec};
