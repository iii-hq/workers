...
| Wire a Rust worker's console UI into its binary (authoring the UI itself is [`ade/skills/`](../ade/skills/)) | [`sops/injectable-console-ui.md`](sops/injectable-console-ui.md) |
