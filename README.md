...
| [`code-runner`](code-runner/) | Rust | Run Node.js and Python in iii-sandbox microVMs — eval code, register bus functions from working source, and tear down runtimes on demand. |
