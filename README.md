...
| Worker | Kind | Summary |
|---|---|---|
| [`agent-guild`](agent-guild/) | Node | Optional public endpoint observations and supplied public passport verification with explicit unknowns; no delegation guard or payment. |
