...
Refresh the upstream profiles, skills and configuration with `./template/sync.sh`;
it preserves the local-source Compose and records the exact imported commit.
