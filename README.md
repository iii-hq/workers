...
| [`pi-cli`](pi-cli/) | Node | The pi coding agent as a TERMINAL on the console — same shape as the `claude-code` terminal, with the iii activity extension reporting pi's runs onto `agent::events`. |
