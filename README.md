...
| [`jev`](jev/) | Rust | Reusable TypeSafe Noul, Choice and Score evaluations through `jev::evaluate`, model discovery through `jev::models::list`, and caller-scoped cancellation. Includes typed contracts, worker-owned credentials, configurable limits and a Console configuration form. |
