...
pub use contract::{
    ...
    GroupCountsV1, GroupGetRequestV1, GroupGetResponseV1, GroupStateResponseV1, GroupStatusV1,
    GroupSummaryV1, GroupsListRequestV1, GroupsListResponseV1, IgnoreBaselineV1, IgnoreRequestV1,
