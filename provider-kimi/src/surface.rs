//! Wire-surface catalog for the `provider::kimi::*` functions — the single
...
pub const COUNT_TOKENS_ID: &str = "provider::kimi::count_tokens";
...
pub const ON_ROUTER_READY_ID: &str = "provider::kimi::on_router_ready";
