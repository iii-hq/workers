 ...
 *
 * The `sandbox-code-runner` configuration entry has no custom form: the
 * console's schema-generated form renders it (its one knob is
 * `inject_guidance`; the operator FILE config — timeouts, idle TTL — never
 * lived in that entry).
 *
