//! The iii-sandbox backend: a desktop running inside an iii-sandbox microVM,
//! driven entirely through iii primitives. No computer-server, no host socket.
//!
...
//! inbound TCP into the guest. So this backend does not connect to anything.
...
#[async_trait]
impl Backend for IiiSandboxHost {
