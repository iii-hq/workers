...
pub fn build_manifest() -> ModuleManifest {
    ModuleManifest {
        ...
        description: "III engine coding worker — scaffold workers, generate functions and triggers, execute code, test, and deploy".to_string(),
        default_config: serde_json::json!({
            "class": "modules::coding::CodingModule",
            "config": {
...
mod tests {
    ...
    fn test_manifest_json_output() {
        ...
        assert_eq!(parsed["name"], "iii-coding");
