...
#[doc(hidden)]
pub fn build_authorize_url(cid: &str, challenge: &str, state: &str, redirect_uri: &str) -> String {
...
/// Internal bus surface for the oauth-google-gemini-cli register handlers.
///
...
pub async fn register_with_iii_with_bus(
    ...
    let login_msg = RegisterFunctionMessage::with_id("oauth::google-gemini-cli::login".to_string())
