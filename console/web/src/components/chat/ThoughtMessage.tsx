...
export function ThoughtMessage({ message }: ThoughtMessageProps) {
  ...
  return (
    <details className="iii-details group/thought" open>
      <summary className="inline-flex items-center gap-2 font-mono text-[12px] text-ink-faint hover:text-ink transition-colors lowercase select-none">
        <span
          aria-hidden
      ...
      <div className="mt-2 ml-2 pl-3 border-l border-rule-2 font-mono text-[13px] leading-[1.7] text-ink-faint italic whitespace-pre-wrap break-words">
        {message.content || (
