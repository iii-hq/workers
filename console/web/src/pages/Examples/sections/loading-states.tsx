...
export function LoadingStatesSection() {
  ...
  return (
    <Section
      id="loading-states"
      eyebrow="loading"
      title="loading & transient states"
      description="every spinner equivalent. ration the accent — at most one pulse per region."
    >
      <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-6">
        <VariantCard label="status dots">
        ...
        <VariantCard label="blinking caret">
        ...
        <VariantCard label="thinking placeholder">
          <div className="font-mono text-[13px] text-ink-faint italic leading-[1.7]">
            thinking…
          </div>
        </VariantCard>

        <VariantCard label="streaming token tail">
          <div className="font-mono text-[14px] text-ink leading-[1.7]">
        ...
        <VariantCard label="trace waterfall" className="@3xl:col-span-2">
