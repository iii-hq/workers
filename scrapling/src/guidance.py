...
GUIDANCE = (
    ...
    "raw HTML that floods context, pass `format: markdown` to any fetch, or use `scrapling::to-markdown` "
    "on HTML you already have. `scrapling::screenshot` returns the rendered page as image blocks you "
    "can see directly. "
