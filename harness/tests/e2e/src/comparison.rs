...
use crate::subject::{ResolvedE2eSubjectV1, SubjectArtifactV1};
...
pub fn comparison_dimension(
    control: &ResolvedE2eSubjectV1,
    treatment: &ResolvedE2eSubjectV1,
...
pub fn compare_runs(
    ...
    control_runs: &[E2eRunReportV1],
    treatment_runs: &[E2eRunReportV1],
...
mod tests {
    ...
    use super::*;
    use crate::report::E2eScenarioReportV1;

    fn subject(model: &str, provider: &str, prompt_hash: &str) -> ResolvedE2eSubjectV1 {
        ResolvedE2eSubjectV1 {
    ...
    fn report(run_id: &str, passed: bool, subject: SubjectArtifactV1) -> E2eRunReportV1 {
        let mut scenario = E2eScenarioReportV1::new(
            "plain_response",
