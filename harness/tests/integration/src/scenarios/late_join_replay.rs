//! INT-009 — a join predecessor registered AFTER its watched session already
...
const SCOPE: &str = "integration-009";
...
pub(super) fn scenario() -> ScenarioFixture {
    ...
    .send(
        Send::message(MESSAGE)
            .idempotency_key("{{run_id}}:integration-009")
            .allow_id(REGISTER)
