//! INT-008 — a reaction session unregisters its registrant's subscription.
//!
...
const SCOPE: &str = "integration-008";
const KEY: &str = "go";

pub(super) fn scenario() -> ScenarioFixture {
    const ID: &str = "INT-008";
    ...
    .send(
        Send::message(MESSAGE)
            .idempotency_key("{{run_id}}:integration-008")
            .allow_id(REGISTER)
            .allow_id(UNREGISTER)
