//! INT-007 — capped fires COALESCE: burst past the rate cap, observe exactly
...
const SCOPE: &str = "integration-007";
const KEY: &str = "burst";
const BURST: usize = 5;
const CAP: usize = 3;

pub(super) fn scenario() -> ScenarioFixture {
    const ID: &str = "INT-007";
    ...
    .send(
        Send::message(MESSAGE)
            .idempotency_key("{{run_id}}:integration-007")
            .allow_id(REGISTER)
