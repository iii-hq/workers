...
pub struct ScenarioContext {
    ...
    subject: Arc<ResolvedAgentQualitySubjectV1>,
...
impl ScenarioContext {
    pub async fn connect(
        url: &str,
        run_id: &str,
        subject: ResolvedAgentQualitySubjectV1,
        invocation_timeout: Duration,
        completion_timeout: Duration,
        ...
        let client = Arc::new(register_worker(
            ...
            InitOptions {
                metadata: Some(WorkerMetadata {
                    ...
                    name: "harness-agent-quality".to_string(),
        ...
        let callback_id = format!("harness-agent-quality::{run_id}::on-turn-completed");
        ...
        client.register_function(
            ...
            .description("Agent-quality runner sink for terminal harness turn events")
    ...
    pub fn subject(&self) -> &ResolvedAgentQualitySubjectV1 {
        &self.subject
    }
