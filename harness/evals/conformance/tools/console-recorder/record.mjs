...
// oracle). Launched by the conformance runner alongside a scenario when
...
// Session id of the conformance run; rows render as
...
try {
  ...
  // The conformance session appears in the conversation sidebar once the
