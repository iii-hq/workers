//! Standalone judge-typesafe over a real engine with loopback-only TypeSafe mocks.
...
async fn independent_consumer_evaluates_mixed_primitives_and_lists_models() {
    ...
    judge_typesafe::register(
        &provider,
        judge_typesafe::configuration::new_cell(judge_typesafe::JevConfig::default()),
        judge_typesafe::JevClient::with_endpoint(
