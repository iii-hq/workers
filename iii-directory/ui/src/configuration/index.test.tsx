...
describe('DirectoryConfigForm function search settings', () => {
  ...
  it('renders Judge without a MiniLM notice, without credentials, and explains the fallback chain', () => {
    ...
    expect(html).toContain('falls back to Hybrid (Lexical without the model)')
    expect(html).toContain('about 6000 ms')
    expect(html).toContain('plays a tournament over the whole catalog')
