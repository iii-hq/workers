//! Wire-schema snapshots for the `provider::openai::*` functions.
//!
//! `provider_openai::surface::catalog()` is the single source of truth for each
...
use provider_openai_codex::surface::{catalog, FunctionSpec};
