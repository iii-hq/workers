...
import { buildFinal, classifyAnthropicError, emptyPartial, handleSseEvent, syntheticErrorEvent } from './sse.js'
...
export async function collect(events: AsyncIterable<AssistantMessageEvent>): Promise<AssistantMessage> {
