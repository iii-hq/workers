/**
 * OpenAI Chat Completions SSE state machine. Mirrors
 * `provider-openai/crates/provider-base/src/openai_compat.rs::handle_chunk`.
 */
...
/**
 * Process one parsed Chat Completions chunk. Returns 0+ events.
 * Returns `null` for the [DONE] sentinel — caller should break.
 */
