...
/// Exactly one of `runtime_id` (a runtime you got back from `code-runner::eval
/// keep=true`) or `namespace` (a `register_function` namespace, e.g. "app"
/// for ids like `app::greet`) must be set — never both, never neither.
