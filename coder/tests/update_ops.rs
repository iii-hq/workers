//! Cross-cutting integration coverage for the batched update applier.
//! The per-module unit tests cover most branches; these tests target the
//! public handler surface and the atomicity invariants spanning multiple
//! files.
...
use coder::functions::update_file::{
