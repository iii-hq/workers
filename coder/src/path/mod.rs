...
//! here and in `shell/src/fs/host.rs` implement the same jail-safety
//! algorithm and MUST evolve in lockstep — port any fix in one file to
//! the other. (Divergence between validated and operated-on paths caused
//! a jail escape in shell; see `lexical_operand` history there.)
