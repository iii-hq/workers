//! Wire-schema snapshots for the `provider::anthropic::*` functions.
//!
//! `provider_anthropic::surface::catalog()` is the single source of truth for
...
use provider_anthropic::surface::{catalog, FunctionSpec};
