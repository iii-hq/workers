...
impl Default for JevConfig {
    fn default() -> Self {
        Self {
            api_key: None,
            model: jev_contract::DEFAULT_MODEL.into(),
            max_request_bytes: jev_contract::DEFAULT_MAX_REQUEST_BYTES,
            max_response_bytes: jev_contract::DEFAULT_MAX_RESPONSE_BYTES,
            max_timeout_ms: jev_contract::DEFAULT_MAX_TIMEOUT_MS,
        }
    }
}
impl JevConfig {
