//! Wire-schema snapshots for the `provider::deepseek::*` functions.
//!
//! `provider_deepseek::surface::catalog()` is the single source of truth for
...
use provider_deepseek::surface::{catalog, FunctionSpec};
