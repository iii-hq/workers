...
/**
 * Single-file ESM bundle for claude-cli (`dist/bundle/index.mjs`).
 *
 ...
 *
 *   2. The console page assets are compiled in through
 *      `src/ui-assets.generated.ts` (see scripts/build-ui.mjs), so run
 *      `pnpm build:ui` before bundling or the worker ships without its page.
 */
