//! Wire-schema snapshots for the `provider::merge-gateway::*` functions.
//!
//! `provider_merge_gateway::surface::catalog()` is the single source of truth for each
...
use provider_merge_gateway::surface::{catalog, FunctionSpec};
