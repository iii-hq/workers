...
pub fn models_url(api_url: &str) -> String {
    ...
    trimmed
        ...
        .unwrap_or_else(|| "https://api-gateway.merge.dev/v1/openai/models".to_string())
}
...
mod tests {
    ...
    fn models_url_derives_from_generation_endpoint() {
        assert_eq!(
            models_url("https://api-gateway.merge.dev/v1/openai/chat/completions"),
        ...
        assert_eq!(
            models_url("https://api-gateway.merge.dev/v1/openai/responses"),
            "https://api-gateway.merge.dev/v1/openai/models"
        );
        assert_eq!(
