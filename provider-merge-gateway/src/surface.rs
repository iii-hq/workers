//! Wire-surface catalog for the `provider::merge-gateway::*` functions — the single
...
pub const STREAM_ID: &str = "provider::merge-gateway::stream";
...
pub const ABORT_ID: &str = "provider::merge-gateway::abort";
...
pub const REFRESH_MODELS_ID: &str = "provider::merge-gateway::refresh_models";
