(function loadHarnessBenchmarkPreview() {
  ...
  const releases = [
    ...
    {
      tag: "provider-zai/v0.4.1",
      worker: "provider-zai",
      version: "0.4.1",
      channel: "next",
      date: Date.UTC(2026, 6, 19, 14),
    ...
    {
      tag: "llm-router/v1.3.2",
      worker: "llm-router",
      version: "1.3.2",
      channel: "latest",
      date: Date.UTC(2026, 6, 21, 9),
    ...
    {
      tag: "provider-zai/v0.5.0",
      worker: "provider-zai",
      version: "0.5.0",
      channel: "experimental",
      date: Date.UTC(2026, 6, 27, 13),
