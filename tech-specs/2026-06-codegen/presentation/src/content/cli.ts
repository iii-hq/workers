...
export const CLI_TRACKS: CliTrack[] = [
  {
    ...
    lines: [
      ...
      {
        out: [
          '→ connecting to engine · ws://127.0.0.1:49134',
          '→ catalog · 42 functions · 9 trigger types',
        ],
      },
      {
        out: [
  ...
  },
  {
    ...
    lines: [
      ...
      {
        out: [
          '✗ src/iii/harness.ts   would change',
          '!  harness::send input drifted since last generate',
        ],
      },
