...
export function Funnel({
  title = 'many paths converge to one',
  paths,
  target,
  reject,
  className,
  ...
  return (
    <div className={cn('border border-rule bg-bg', className)}>
      ...
      <div className="overflow-x-auto p-3">
        ...
        >
          <defs>
            <marker id="fun-arr" viewBox="0 0 8 8" refX="7" refY="4" markerWidth="6.5" markerHeight="6.5" orient="auto-start-reverse">
              <path d="M 0 0 L 8 4 L 0 8 z" className="fill-ink-faint" />
            </marker>
            <marker id="fun-arr-accent" viewBox="0 0 8 8" refX="7" refY="4" markerWidth="6.5" markerHeight="6.5" orient="auto-start-reverse">
              <path d="M 0 0 L 8 4 L 0 8 z" className="fill-accent" />
            </marker>
            <marker id="fun-arr-alert" viewBox="0 0 8 8" refX="7" refY="4" markerWidth="6.5" markerHeight="6.5" orient="auto-start-reverse">
