      ...
      <div className="grid grid-cols-1 @4xl:grid-cols-2 gap-x-16 gap-y-12 px-4 pt-16 pb-14 @3xl:px-9 @3xl:pt-24 @3xl:pb-20">
        <div className="min-w-0">
          ...
          <p className="mt-6 font-mono text-[14px] leading-[1.7] text-ink-faint lowercase max-w-[58ch]">
            you already write{' '}
            <span className="text-ink">iii.trigger({'{ function_id, payload }'})</span>{' '}
            by hand. codegen reads the engine's live catalog and generates the{' '}
            <span className="text-ink">typed wrapper</span> for you, in
            typescript, rust, python, and javascript.
          </p>
              ...
              <TerminalRow
                ...
                output={
                  <span className="tabular-nums">
                    {'↳ SendResult { session_id, turn_id, accepted }'}
                  </span>
                }
              />
