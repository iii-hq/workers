...
const ROWS = [
  {
    ...
    problemDetail:
      'call sites welded to one vendor sdk; every new model is a migration.',
  ...
  },
  {
    ...
    problemDetail:
      'an agent dies with its process; restarts replay side effects or lose answers.',
  ...
  },
  {
    ...
    problemDetail:
      'what is it doing? consumers guess, scrape logs, or chase status endpoints.',
  ...
  },
  {
    ...
    problemDetail:
      'a capable model with implicit access is an incident report waiting to be written.',
  ...
  },
  {
    ...
    problemDetail:
      'one process that owns storage, context, providers, approvals — and every change risks all of it.',
  ...
  },
  {
    ...
    problemDetail:
      'every new ability an agent needs becomes a bespoke adapter to write and maintain.',
        ...
        {ROWS.map((row, i) => (
          ...
          >
            <div className="px-5 py-5 border-l-2 border-l-alert/60 bg-alert/5 @3xl:border-r @3xl:border-r-rule">
              <div className="font-mono text-[14px] font-semibold lowercase text-ink">
                {row.problem}
              </div>
