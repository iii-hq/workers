      ...
      <div className="grid grid-cols-1 @4xl:grid-cols-2 gap-x-16 gap-y-12 px-4 pt-16 pb-14 @3xl:px-9 @3xl:pt-24 @3xl:pb-20">
        <div className="min-w-0">
          ...
          <p className="mt-6 font-mono text-[14px] leading-[1.7] text-ink-faint lowercase max-w-[56ch]">
            an agentic stack assembled from standalone iii workers that talk
            only over the bus — <span className="text-ink">reactive</span> at
            every surface, <span className="text-ink">durable</span> at every
            step, <span className="text-ink">governable</span> at every call.
          </p>
              ...
              <TerminalRow
                ...
                output={
                  <span className="flex items-center gap-x-2">
                    <StatusDot pulse />
                    <span>
                      connected — with session-manager, context-manager,
                      llm-router
                    </span>
                  </span>
                }
