...
const OTHERS: Array<{ id: string; href: string; label: string }> = [
  { id: 'telegram', href: '#/use-cases/telegram', label: 'telegram bot' },
  { id: 'console', href: '#/use-cases/console', label: 'console chat' },
  { id: 'loops', href: '#/use-cases/loops', label: 'agentic loops' },
]
