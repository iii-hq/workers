          ...
          <g key={edge.id}>
            ...
            {edge.label ? (
              <text
                ...
                className={cn(
                  active ? 'fill-ink' : 'fill-ink-ghost',
        ...
        return (
          ...
          >
            ...
            <text
              ...
              className={cn(
                'uppercase',
                isSelected ? 'fill-accent' : 'fill-ink-ghost',
              )}
            >
                  ...
                  {section.dotted ? (
                    <span className="flex items-baseline gap-x-2 min-w-0">
                      ...
                      <span className="min-w-0">
                        ...
                        {item.desc ? (
                          <span className="font-mono text-[11.5px] text-ink-faint lowercase">
                            {' '}
                            — {item.desc}
                          </span>
                        ) : null}
