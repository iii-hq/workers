      ...
      <div className="grid grid-cols-1 @4xl:grid-cols-2 gap-x-16 gap-y-12 px-4 pt-16 pb-14 @3xl:px-9 @3xl:pt-24 @3xl:pb-20">
        <div className="min-w-0">
          ...
          <p className="mt-6 font-mono text-[14px] leading-[1.7] text-ink-faint lowercase max-w-[58ch]">
            the engine&apos;s role-based access control, moved in front of the
            engine: a <span className="text-ink">separate process</span>, the{' '}
        ...
        <div className="min-w-0 self-center">
          <Terminal title="the boundary, in two frames">
            <div className="flex flex-col gap-y-2.5">
              <TerminalRow
                command="iii trigger compose::add worker=rbac-proxy"
                output={
              ...
              <TerminalRow
                command={
                  <>
                    worker-b → invoke{' '}
                    <span className="text-ink-faint">api::admin::purge</span>
                  </>
                }
                output={
                  <span className="text-alert">
                    ✗ FORBIDDEN &nbsp;&apos;api::admin::purge&apos; not allowed
                  </span>
                }
              />
