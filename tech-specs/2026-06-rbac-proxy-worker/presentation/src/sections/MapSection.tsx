        ...
        <SpecSheet title="the two connection planes" meta="control + data">
          <div className="flex flex-col">
            <SpecRow name="control connection" type="one, persistent">
              the proxy&apos;s own worker identity. registers rbac-proxy::status,
              invokes auth / middleware / hooks, runs the catalog caches, and
              integrates with configuration.
            </SpecRow>
            <SpecRow name="data connection" type="one per downstream">
              a fresh upstream websocket per inbound worker, frames pumped both
              ways through the interceptor.
            </SpecRow>
            <SpecRow name="cleanup" type="inherited">
              downstream close → upstream close; the engine&apos;s per-connection
              teardown removes that connection&apos;s functions and triggers.
            </SpecRow>
          </div>
        </SpecSheet>
        ...
        <SpecSheet title="what it never does" meta="pure boundary">
          <div className="flex flex-col">
            <SpecRow name="touch the engine" type="no">
              no engine, protocol, or port changes; worker code against the
            ...
            <SpecRow name="replace engine rbac" type="no">
              an alternative home for the same rules; run the gateway, the proxy,
              or both.
            </SpecRow>
            <SpecRow name="re-issue access_keys" type="no">
              channel sockets are relayed; the engine validates the capability
              token.
            </SpecRow>
          </div>
        </SpecSheet>
