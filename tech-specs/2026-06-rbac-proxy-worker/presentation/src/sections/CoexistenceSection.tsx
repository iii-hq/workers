      ...
      <div className="mt-6">
        <SpecSheet title="migration is a config copy" meta="same field set">
          <p className="font-mono text-[13px] leading-[1.7] text-ink-faint lowercase mb-4">
            the proxy&apos;s WorkerConfig is intentionally the same field set as
            the engine&apos;s gateway: block, so an operator&apos;s mental model
            transfers and moving between the two is a copy, not a rewrite.
          </p>
