...
export const MAP_NODES: MapNode[] = [
  { id: 'clients', x: 36, y: 250, w: 168, h: 66, title: 'sdk workers', sub: 'bearer / api_key', kind: 'external', tag: 'untrusted' },
  { id: 'interceptor', x: 300, y: 120, w: 190, h: 68, title: 'interceptor', sub: 'gate · prefix · rewrite', kind: 'primary', tag: 'proxy' },
  { id: 'port', x: 300, y: 258, w: 190, h: 58, title: 'public port', sub: 'host:port', kind: 'primary', tag: 'proxy' },
  { id: 'channels', x: 300, y: 410, w: 190, h: 56, title: 'channel bridge', sub: '/ws/channels/{id}', kind: 'secondary', tag: 'proxy' },
  { id: 'control', x: 560, y: 410, w: 190, h: 56, title: 'control conn', sub: 'auth · hooks · caches', kind: 'primary', tag: 'proxy' },
  { id: 'policy', x: 560, y: 120, w: 190, h: 68, title: 'policy fns', sub: 'auth · mw · hooks', kind: 'external', tag: 'trusted' },
  { id: 'engine', x: 830, y: 252, w: 164, h: 68, title: 'engine', sub: ':49134 · no rbac', kind: 'primary', tag: 'trusted' },
  { id: 'config', x: 830, y: 410, w: 164, h: 56, title: 'configuration', sub: 'rbac-proxy config', kind: 'external', tag: 'trusted' },
]

export const MAP_EDGES: MapEdge[] = [
  { id: 'frames', from: 'clients', to: 'port', d: 'M 204 283 L 300 287', label: 'ws frames', lx: 252, ly: 276, dur: 1.8 },
  { id: 'pump', from: 'port', to: 'interceptor', d: 'M 395 258 L 395 188', label: 'per connection', lx: 403, ly: 226, anchor: 'start', dur: 1.6 },
  { id: 'upstream', from: 'interceptor', to: 'engine', d: 'M 490 150 C 700 150, 745 252, 830 268', label: 'upstream ws (rewritten)', lx: 660, ly: 168, dur: 2.2 },
  { id: 'chan-in', from: 'clients', to: 'channels', d: 'M 120 316 C 120 438, 210 438, 300 438', label: '/ws/channels/{id}', lx: 132, ly: 372, anchor: 'start', dashed: true, dur: 2.4 },
  { id: 'bridge', from: 'channels', to: 'engine', d: 'M 490 438 C 690 438, 770 360, 860 320', label: 'bridge 1:1', lx: 660, ly: 432, dur: 2.2 },
  { id: 'identity', from: 'control', to: 'engine', d: 'M 750 432 C 800 424, 850 360, 872 320', label: 'register · iii.trigger', lx: 812, ly: 410, anchor: 'start', dur: 2 },
  { id: 'invoke-policy', from: 'control', to: 'policy', d: 'M 655 410 L 655 188', label: 'auth / mw / hooks', lx: 663, ly: 304, anchor: 'start', dur: 1.8 },
  { id: 'cfg', from: 'control', to: 'config', d: 'M 750 438 L 830 438', label: 'config feed', lx: 790, ly: 430, dur: 1.8 },
]
