...
export const COMPARE_ROWS: CompareRow[] = [
  ...
  { property: 'front a remote or managed engine', gateway: 'no, it is engine config', proxy: 'yes, a worker pointed at a url', win: true },
  ...
  { property: 'discovery result filtering', gateway: 'partial: 2 of 8, in-process', proxy: 'all 8, client-side', win: true },
