//! Wire-schema snapshots for the `provider::zai::*` functions.
//!
//! `provider_zai::surface::catalog()` is the single source of truth for each
...
use provider_zai::surface::{catalog, FunctionSpec};
