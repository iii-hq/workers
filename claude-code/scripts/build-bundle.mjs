...
/**
 * Single-file ESM bundle for claude-code (`dist/bundle/index.mjs`).
 *
 ...
 *
 *   2. `@anthropic-ai/claude-agent-sdk` spawns the Claude Code CLI as a
 *      subprocess; the `claude_executable` config option (or a `claude`
 *      binary on PATH) covers the bundled case where the SDK cannot
 *      resolve its own vendored entrypoint.
 */
