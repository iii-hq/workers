...
pub async fn register_with_iii(iii: &iii_sdk::III) -> anyhow::Result<OAuthFunctionRefs> {
    ...
    let login_fn = iii.register_function((
        RegisterFunctionMessage::with_id("oauth::openai-codex::login".to_string())
    ...
    let refresh_fn = iii.register_function((
        RegisterFunctionMessage::with_id("oauth::openai-codex::refresh".to_string())
    ...
    let status_fn = iii.register_function((
        RegisterFunctionMessage::with_id("oauth::openai-codex::status".to_string())
