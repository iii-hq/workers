...
pub fn render_worker(dir: &Path) -> anyhow::Result<RenderOutput> {
    ...
    let readme = render_readme(name, &intro, &quickstart, &config, migration.as_deref());
...
fn render_readme(
    ...
    let mut sections: Vec<String> = vec![
        "<!-- generated by iii-skill-render — edit docs/intro.md, docs/quickstart.md, docs/migration.md, iii.worker.yaml, or config.yaml -->".to_string(),
        format!("# {name}"),
        intro.to_string(),
        format!(
