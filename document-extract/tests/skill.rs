...
fn router_well_formed() {
    well_formed("router", document_extract::SKILL_MD);
    id_is_valid("router", document_extract::SKILL_ID);
}

#[test]
fn sub_skills_well_formed() {
    let prefix = format!("{}/", document_extract::SKILL_ID);
