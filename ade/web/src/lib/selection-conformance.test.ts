...
describe('neutral selection contract', () => {
  ...
  it('keeps selected native Console labels and outlines neutral', () => {
    const sources = [
      'ade/web/src/components/chat/DirectoryPicker.tsx',
      'ade/web/src/components/workspace/EmptyPane.tsx',
      'ade/web/src/components/workspace/MobileWorkspaceMenu.tsx',
      'ade/web/src/components/chat/ModelPicker.tsx',
      'ade/web/src/components/chat/SessionAddonsPicker.tsx',
      'ade/web/src/components/chat/MemoryChip.tsx',
      'ade/web/src/pages/Configuration/index.tsx',
      'ade/web/src/pages/TracesV2/components/ViewsDropdown.tsx',
      'ade/web/src/pages/TracesV2/components/WaterfallChart.tsx',
      'ade/web/src/pages/TracesV2/components/timeline/spanVisuals.tsx',
  ...
  it('keeps command palette filters and result selection neutral', () => {
    const source = readFileSync(
      join(repoRoot, 'ade/web/src/components/CommandPalette.tsx'),
      'utf8',
    )
  ...
  it('keeps Monaco selections and selected suggestions neutral', () => {
    const source = readFileSync(
      join(repoRoot, 'ade/web/src/lib/monaco.ts'),
      'utf8',
    )
