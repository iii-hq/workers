 ...
 * Sort by (single choice), then Clear filters. The trigger takes the
 * selected wash while any setting differs from its default, so a hidden
 * kind is never a surprise.
 *
