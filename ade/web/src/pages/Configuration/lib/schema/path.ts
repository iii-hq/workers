 ...
 * configuration form components receive a path slice + the loaded value root
 * and use these helpers to read/write without re-implementing the "build the
 ...
 * and RFC 6901 JSON Pointer) because the structured path is what the
...
import type { JsonValue } from '../../tabs/WorkersTab/api'
