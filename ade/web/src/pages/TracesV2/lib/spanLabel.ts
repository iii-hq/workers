...
// workers/ade/docs/timeline-span-tags.md): a producing worker stamps
 ...
 * workers/ade/docs/timeline-span-tags.md: it carries a kind its
 ...
 * workers/ade/docs/timeline-span-tags.md: baggage copies `iii.tag.*`
