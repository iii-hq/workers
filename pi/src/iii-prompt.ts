/**
 * iii runtime context appended to the system prompt when `iii_context` is
 ...
 * its shell. The override rule matches the harness: a caller-supplied
 * `system_prompt` wins and nothing is appended to it.
 */
