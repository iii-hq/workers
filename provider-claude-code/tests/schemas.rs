//! Wire-schema snapshots for the `provider::claude-code::*` functions.
//!
//! `provider_claude_code::surface::catalog()` is the single source of truth for
...
use provider_claude_code::surface::{catalog, FunctionSpec};
