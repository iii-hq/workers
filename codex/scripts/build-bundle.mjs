...
/**
 * Single-file ESM bundle for codex (`dist/bundle/index.mjs`).
 *
 ...
 *
 *   2. `@openai/codex-sdk` spawns the Codex CLI as a subprocess; the
 *      `codex_executable` config option (or a `codex` binary on PATH)
 *      covers the bundled case where the SDK cannot resolve its own
 *      vendored entrypoint.
 */
