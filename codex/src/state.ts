 ...
 * session_id. Maps iii sessions to Codex thread ids so `codex::run` with the
 * same session_id resumes the underlying Codex thread (persisted by the CLI
 * in ~/.codex/sessions).
 */
