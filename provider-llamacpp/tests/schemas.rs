//! Wire-schema snapshots for the `provider::llamacpp::*` functions.
//!
//! `provider_llamacpp::surface::catalog()` is the single source of truth for each
...
use provider_llamacpp::surface::{catalog, FunctionSpec};
