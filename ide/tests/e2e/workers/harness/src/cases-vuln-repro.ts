...
// `feat/ide-e2e-harness` review. Originally these cases passed
...
export const VULN_REPRO_CASES: TestCase[] = [
  {
    // S-H1: ide/src/fs/host.rs (chmod handler).
  ...
  {
    // S-H2: ide/src/config.rs (validate_fs_jail).
  ...
  {
    // S-H3: ide/src/config.rs:148-171 + ide/config.yaml + README.md.
  ...
  {
    // S-H4: ide/src/jobs.rs + ide/src/functions/list.rs +
    // ide/src/functions/types.rs.
