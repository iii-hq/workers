...
use ide::code::functions::{catalog, FunctionSpec};
...
fn info_example_round_trips() {
    let _input: ide::code::functions::info::InfoInput = example_as("coder::info", 0);
}

#[test]
fn read_file_single_example_round_trips_with_window() {
    let input: ide::code::functions::read_file::ReadFileInput = example_as("coder::read-file", 0);
...
fn read_file_batch_example_round_trips_with_both_target_forms() {
    use ide::code::functions::read_file::{ReadFileInput, ReadTarget};
...
fn search_example_round_trips() {
    let input: ide::code::functions::search::SearchInput = example_as("coder::search", 0);
...
fn create_file_example_round_trips_with_relative_and_absolute_entries() {
    let input: ide::code::functions::create_file::CreateFileInput =
...
fn delete_file_example_round_trips() {
    let input: ide::code::functions::delete_file::DeleteFileInput =
...
fn list_folder_example_round_trips() {
    let input: ide::code::functions::list_folder::ListFolderInput =
...
fn tree_example_round_trips() {
    let input: ide::code::functions::tree::TreeInput = example_as("coder::tree", 0);
...
fn move_example_round_trips_with_in_root_absolute_destination() {
    let input: ide::code::functions::move_file::MoveFileInput = example_as("coder::move", 0);
    assert_eq!(input.files.len(), 2);
    assert!(!input.files[0].overwrite);
    assert!(input.files[1].overwrite);
