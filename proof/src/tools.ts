...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    description:
      'Get the current page accessibility tree. Interactive elements have [ref=eN] markers. Use these refs in click, type, select, and press tools.',
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        resource_type: {
          type: 'string',
          description: 'Filter by type: xhr, fetch, document, script, stylesheet, image',
        },
  ...
  },
  {
    ...
    description:
      'Execute raw Playwright code. Has access to page, context, browser, and ref() function. Returns the result as JSON.',
    input_schema: {
      type: 'object',
      properties: {
        code: {
          type: 'string',
          description:
            "Playwright code to execute. Use ref('e3') to get locators from snapshot refs. Must return a value.",
        },
      },
      required: ['code'],
    },
